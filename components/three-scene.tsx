...
const projectsData = [
  ...
  },
  {
    ...
    github: "https://github.com/santiago/econest",
    demo: "https://econest-demo.vercel.app",
    category: "Full-Stack",
    featured: true,
  ...
  },
  {
    ...
    github: "https://github.com/santiago/sparrow",
    demo: "https://sparrow-learn.vercel.app",
    category: "Education",
    featured: false,
...
export function ThreeScene() {
  ...
  return (
    <>
      ...
      <h2 className="text-3xl font-bold bg-gradient-to-r from-primary to-orange-400 bg-clip-text text-transparent ml-15 mt-10">
